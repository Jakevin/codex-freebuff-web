...
$Stage = Join-Path $env:RUNNER_TEMP "codex-freebuff-web-bun-baseline-$Version"
...
Add-Content -LiteralPath $GitHubEnv -Value "CODEX_FREEBUFF_WEB_EMBEDDED_BUN=$Bun" -Encoding UTF8
